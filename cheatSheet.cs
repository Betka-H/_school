// ctrl+shit+p -> .NET: new project -> console app
...
static void printArray(int[] a) // print an array
{
...
Console.Title = "this is the console title :))";

Console.WriteLine(DateTime.Now);

Random inTheFuture = new Random();
int entertainmentWillBeRandomlyGenerated = rnd1.Next(0, 42);
...
// file management
string[] lines = File.ReadAllLines("C:\\Users\\eliza\\Downloads\\inputFile.txt"); // 1 line = 1 array element
